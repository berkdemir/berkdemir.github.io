...
# SOFiSTiK Method
There are a LOT of STR FE tools and I am not claiming that I am aware of the capabilities of all of the ones out there.  (Please reach out if you know more - so I can try them out or I can update the post with new information.) But at least, I know that SOFiSTiK can do multi-layer design, but not without simplifications. User is asked to define the multi-layer reinforcement arrangement by LAY method.
